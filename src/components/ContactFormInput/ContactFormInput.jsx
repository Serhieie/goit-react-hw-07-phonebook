  ...
  return (
    <>
      ...
      <Field
        ...
        className="text-center mx-auto w-11/12 py-1 px-5 rounded-sm h-9
         ...
         md2:text-2 ssm:text-xs md2:text-xs font-light"
      />
      <label
        htmlFor="phone"
      ...
      <Field
        ...
        className="text-center w-11/12 py-1 px-5 rounded-sm h-9 bg-lightPartsColor 
